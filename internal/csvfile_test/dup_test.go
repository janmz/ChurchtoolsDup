...
func TestReadDupAcceptsBOMInHeaderOnly(t *testing.T) {
	csvText := "\ufeffDupID,ID,Vorname,Nachname,E-Mail,Straße,Stadt,Standort,Erstellungsdatum,Einwilligungsdatum\n1,1537,,,,,,,,\n"
	dir := t.TempDir()
	path := filepath.Join(dir, "dup.csv")
...
func TestReadDupAcceptsSemicolonDelimiter(t *testing.T) {
	header := "DupID;ID;Vorname;Nachname;E-Mail;Straße;Stadt;Standort;Erstellungsdatum;Einwilligungsdatum"
